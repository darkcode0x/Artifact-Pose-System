            ...
            children: [
              ...
              _ImageCard(
                ...
                url: inspection.annotatedImagePath != null
                    ? ApiConfig.resolveAssetUrl(inspection.annotatedImagePath)
                    : null,
                emptyLabel: 'No damage annotations\n(No detections from AI model)',
              ),
              const SizedBox(height: 16),

              // ── Image 3: Pose-aligned ─────────────────────────────────
              _ImageCard(
                title: 'Pose-Aligned Image',
                icon: Icons.compare_outlined,
                url: inspection.alignedImagePath != null
      ...
      children: [
        Row(
          children: [
            ...
            const Spacer(),
            const Icon(Icons.pinch_outlined, size: 14, color: AppColors.textFaint),
